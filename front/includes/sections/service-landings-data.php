    ...
    function service_landings_catalog(): array
    {
        return [
            ...
            'finance' => [
                ...
                'hero_text' => 'تقدّم طلبك إلكترونياً، تابع المراجعة والإحالة الاستشارية، وصولاً إلى عرض التمويل من البنوك والجهات الشريكة.',
                ...
                'benefits' => [
                    ...
                    'مراجعة أولية من الهيئة ثم إحالة استشارية آلية',
                    'سحابة قروض غير ممولة للجهات التمويلية',
                    'متابعة حالة الطلب خطوة بخطوة',
                ],
                'roadmap_title' => 'خارطة رحلة طلب التمويل',
                'roadmap_note' => 'كل مرحلة توضّح المطلوب من مقدّم الطلب. الإحالة للمكتب الاستشاري وعرض السعر تتم بعد الإرسال والمراجعة.',
                'steps' => [
                    ...
                    ['icon' => 'bi-building', 'title' => 'المكاتب الاستشارية', 'desc' => 'بعد الإرسال تُحال المعاملة لمكتب معتمد — دون اختيار يدوي.'],
