    ...
    <div class="container">
      <div class="row align-items-center g-4">
        <div class="col-lg-7">
          ...
          <p>
            واجهة مؤسسية رسمية تنظّم طلبات التمويل ضمن مسار واضح يبدأ من تقديم الطلب، ويمر عبر المكتب الاستشاري المختص،
            ثم ينتقل إلى المراجعة والاعتماد والتمويل، مع مؤشرات تنفيذية تساعد الإدارة والجهات التمويلية على المتابعة واتخاذ القرار.
          </p>
        ...
        <div class="row g-3">
          <div class="col-lg-3 col-md-6">
            <div class="fg-mini-stat">
              ...
              <div>
                <strong>مكتب استشاري دائم</strong>
                <span>كل طلب يمر بمكتب مؤهل لتجهيز الدراسة والملف.</span>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="fg-flow">
        ...
        <div class="fg-step">
          ...
          <h3>ربط استشاري دائم</h3>
          <p>كل طلب يذهب لمكتب استشاري مؤهل حسب القطاع والاختصاص والمحافظة.</p>
        </div>

        <div class="fg-step">
          <div class="fg-step-num">3</div>
          <h3>تجهيز الملف</h3>
          <p>إعداد الدراسة، ترتيب المستندات، مراجعة البيانات المالية، وتجهيز ملف التمويل.</p>
        </div>

        <div class="fg-step">
          <div class="fg-step-num">4</div>
          <h3>سحابة التمويل</h3>
          <p>عرض الطلب الجاهز للبنوك والجهات التمويلية حسب معايير الفرز والمطابقة.</p>
        </div>
          ...
          <div class="col-lg-7">
            ...
            <div class="mt-3 p-3 rounded-4 bg-white border" style="border-color:var(--fg-line)!important;">
              ...
              <span class="text-muted" style="line-height:1.85;">
                المكتب الاستشاري لا يطابق فقط كلمة “صناعي” أو “خدمي”، بل يطابق القطاع مع رمز SYRSIC والاختصاص المطلوب.
              </span>
            </div>
          </div>
        </div>
