...
$menus = [
  ...
  'project_services_manager' => [
    ...
    ['href' => $basePath.'services/training/program-bank-dashboard.php',  'icon' => 'bi-collection-fill',     'label' => 'بنك الحقائب'],
    ['href' => $basePath.'services/training/program-bank-list.php',       'icon' => 'bi-list-ul',             'label' => 'كل الحقائب'],
    ['href' => $basePath.'services/training/program-bank-form.php',       'icon' => 'bi-plus-circle-fill',    'label' => 'حقيبة جديدة'],
    ['href' => $basePath.'services/training/training-kits-list.php',      'icon' => 'bi-box-seam-fill',       'label' => 'الحقائب المطبوعة'],
