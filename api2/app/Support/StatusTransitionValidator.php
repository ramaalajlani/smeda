...
class StatusTransitionValidator
{
    ...
    private const TRANSITIONS = [
        ...
        FundingApplication::class => [
            'draft' => ['submitted'],
            'needs_completion' => ['submitted', 'branch_review', 'consultant_review', 'rejected'],
            'submitted' => ['branch_review', 'consultant_review', 'needs_completion', 'rejected'],
            'branch_review' => ['branch_review', 'consultant_review', 'needs_completion', 'rejected'],
