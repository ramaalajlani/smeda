...
class TrainerRegistrationRequestPolicy

{
    ...
    public function view(?User $user, TrainerRegistrationRequest $request): bool
...

    {
        ...
        return $this->hasPermission($user, 'create_trainer_registration_requests');

    }



    public function review(?User $user, TrainerRegistrationRequest $request): bool

    {

        return $this->hasPermission($user, 'review_trainer_registration_requests')
